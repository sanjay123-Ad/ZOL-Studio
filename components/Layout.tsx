      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="lg:hidden bg-white/80 dark:bg-gray-800/80 backdrop-blur-md border-b border-gray-200 dark:border-gray-700 p-4 flex items-center justify-between z-10">
          <div className="flex items-center gap-3">
            <img src="/logo.png" alt="Zol Studio AI" className="h-10 w-10 object-contain" />
            <div className="flex flex-col justify-center">
              <span className="text-[#2E1E1E] dark:text-white text-base font-semibold font-headline leading-tight">Zol Studio AI</span>
