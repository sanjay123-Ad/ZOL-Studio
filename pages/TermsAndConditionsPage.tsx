          ...
          <div className="max-w-none">
            ...
            <section className="mb-12">
              <p className="text-base text-slate-700 leading-relaxed mb-6 font-normal">
                Welcome to ZOLA AI Fashion Studio ("we," "our," or "us"). These Terms and Conditions ("Terms") govern your access to and use of our AI-powered fashion e-commerce platform, including our website, services, and applications (collectively, the "Service").
              </p>
              <p className="text-base text-slate-700 leading-relaxed font-normal">
                By accessing or using ZOLA AI Fashion Studio, you agree to be bound by these Terms. If you do not agree to these Terms, please do not use our Service.
              </p>
            </section>
            ...
            <section className="mb-12">
              ...
              <p className="text-base text-slate-700 leading-relaxed mb-4 font-normal">
                By accessing and placing an order with ZOLA AI Fashion Studio, you confirm that you are in agreement with and bound by the terms of service contained in the Terms & Conditions outlined below. These terms apply to the entire website and any email or other type of communication between you and ZOLA AI.
              </p>
              <p className="text-base text-slate-700 leading-relaxed font-normal">
                Under no circumstances shall ZOLA AI team be liable for any direct, indirect, special, incidental or consequential damages, including, but not limited to, loss of data or profit, arising out of the use, or the inability to use, the materials on this site, even if ZOLA AI team or an authorized representative has been advised of the possibility of such damages.
              </p>
            </section>
            ...
            <section className="mb-12">
              ...
              <ul className="list-disc pl-6 space-y-3 text-base text-slate-700 leading-relaxed">
                ...
                <li><strong>Company:</strong> When these Terms mention "Company," "we," "us," or "our," it refers to ZOLA AI Fashion Studio, which is responsible for your information under these Terms.</li>
                <li><strong>Service:</strong> Refers to the service provided by ZOLA AI Fashion Studio as described in the relative terms (if available) and on this platform.</li>
                <li><strong>Website:</strong> ZOLA AI Fashion Studio's site, which can be accessed via this URL: https://zolaai.com</li>
                <li><strong>You:</strong> A person or entity that is registered with ZOLA AI Fashion Studio to use the Service.</li>
            ...
            <section className="mb-12">
              ...
              <p className="text-base text-slate-700 leading-relaxed mb-6 font-normal">
                Permission is granted to temporarily access the materials on ZOLA AI Fashion Studio's website for personal, non-commercial transitory viewing only. This is the grant of a license, not a transfer of title, and under this license you may not:
              </p>
              <ul className="list-disc pl-6 space-y-3 text-base text-slate-700 leading-relaxed">
                <li>Modify or copy the materials</li>
                <li>Use the materials for any commercial purpose or for any public display (commercial or non-commercial)</li>
                <li>Attempt to reverse engineer any software contained on ZOLA AI Fashion Studio's website</li>
                <li>Remove any copyright or other proprietary notations from the materials</li>
                <li>Transfer the materials to another person or "mirror" the materials on any other server</li>
              </ul>
              <p className="text-base text-slate-700 leading-relaxed mt-6 font-normal">
                This license shall automatically terminate if you violate any of these restrictions and may be terminated by ZOLA AI at any time. Upon terminating your viewing of these materials or upon the termination of this license, you must destroy any downloaded materials in your possession whether in electronic or printed format.
              </p>
            </section>
            ...
            <section className="mb-12">
              ...
              <p className="text-base text-slate-700 leading-relaxed mb-6 font-normal">
                ZOLA AI Fashion Studio offers various subscription plans with different features and credit allocations. Subscription fees are billed in advance on a monthly or annual basis, as selected by you.
              </p>
            ...
            <section className="mb-12">
              ...
              <p className="text-base text-slate-700 leading-relaxed mb-6 font-normal">
                The Service and its original content, features, and functionality are and will remain the exclusive property of ZOLA AI Fashion Studio and its licensors. The Service is protected by copyright, trademark, and other laws. Our trademarks and trade dress may not be used in connection with any product or service without our prior written consent.
              </p>
              ...
              <p className="text-base text-slate-700 leading-relaxed mb-6 font-normal">
                All content generated using ZOLA AI Fashion Studio is provided with a commercial license. You own the rights to use generated content for commercial purposes. However, you may not:
              </p>
              <ul className="list-disc pl-6 space-y-3 text-base text-slate-700 leading-relaxed">
            ...
            <section className="mb-12">
              ...
              <p className="text-base text-slate-700 leading-relaxed mb-6 font-normal">
                ZOLA AI Fashion Studio offers a 30-day money-back guarantee for first-time subscribers. To be eligible for a refund:
              </p>
              <ul className="list-disc pl-6 space-y-3 text-base text-slate-700 leading-relaxed">
            ...
            <section className="mb-12">
              ...
              <p className="text-base text-slate-700 leading-relaxed mb-6 font-normal">
                In no event shall ZOLA AI Fashion Studio, nor its directors, employees, partners, agents, suppliers, or affiliates, be liable for any indirect, incidental, special, consequential, or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses, resulting from:
              </p>
              <ul className="list-disc pl-6 space-y-3 text-base text-slate-700 leading-relaxed">
            ...
            <section className="mb-12">
              ...
              <p className="text-base text-slate-700 leading-relaxed mb-6 font-normal">
                You agree to defend, indemnify, and hold harmless ZOLA AI Fashion Studio and its licensee and licensors, and their employees, contractors, agents, officers and directors, from and against any and all claims, damages, obligations, losses, liabilities, costs or debt, and expenses (including but not limited to attorney's fees), resulting from or arising out of:
              </p>
              <ul className="list-disc pl-6 space-y-3 text-base text-slate-700 leading-relaxed">
            ...
            <section className="mb-12">
              ...
              <p className="text-base text-slate-700 leading-relaxed font-normal">
                These Terms shall be interpreted and governed by the laws of the jurisdiction in which ZOLA AI Fashion Studio operates, without regard to its conflict of law provisions. Our failure to enforce any right or provision of these Terms will not be considered a waiver of those rights.
              </p>
            </section>
