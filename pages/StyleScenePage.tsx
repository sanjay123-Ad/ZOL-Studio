...
import { GarmentIcon, DownloadIcon, FixItIcon, ChangeBackgroundIcon, ExpandIcon } from '../components/icons';
                                ...
                                <div key={pose.id} className="flex flex-col">
                                    ...
                                    <button
                                        ...
                                        className={`mt-1 w-full text-xs font-semibold py-1.5 rounded-full transition-colors flex items-center justify-center h-7 ${
                                            ...
                                            state.status === 'error' ? 'bg-sky-600 text-white hover:bg-sky-700' :
