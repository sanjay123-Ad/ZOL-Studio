    ...
    <>
        ...
        >
          ...
          <div className="hidden md:flex items-center space-x-2 relative" ref={featuresRef}>
            <button
              ...
              className={`px-5 py-2.5 text-base font-bold rounded-full hover:bg-sky-50 transition-all flex items-center gap-1.5 ${
                isFeaturesOpen ? 'text-sky-600 bg-sky-50' : 'text-slate-600 hover:text-sky-600'
              }`}
            >
              Features
              <svg
            ...
            <a href="#" className="px-5 py-2.5 text-base font-bold text-slate-600 hover:text-sky-600 rounded-full hover:bg-sky-50 transition-all">
              Studio
            </a>
            <button
              onClick={(e) => {
      ...
      {isFeaturesOpen && (
        <div className="fixed top-24 left-0 right-0 z-40 flex justify-center px-4 pointer-events-none">
          <div className="pointer-events-auto bg-white rounded-2xl shadow-2xl border border-slate-200/60 max-w-4xl w-full p-6 md:p-8 mt-4 transform transition-all duration-200 ease-out opacity-100 translate-y-0">
