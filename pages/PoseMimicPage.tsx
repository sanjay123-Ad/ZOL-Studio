  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      for (const f of validFiles) {
        if (f.status === 'success' || f.status === 'error') continue;
        ...
        try {
          ...
          await deductCredits(user.id, CREDITS_PER_IMAGE, 'pose_mimic');
    ...
    <div className="min-h-screen flex flex-col items-center p-4 sm:p-6 lg:p-8 bg-gradient-to-b from-sky-50 via-white to-white dark:from-gray-900 dark:via-gray-900 dark:to-gray-900 transition-colors duration-200">
      <main className="w-full max-w-7xl">
        ...
        <div className="text-center mb-3 sm:mb-4">
          ...
          <h1 className="text-4xl sm:text-5xl font-bold text-gray-900 dark:text-white font-headline">AI Pose Mimic</h1>
